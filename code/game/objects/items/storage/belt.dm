...
/obj/item/storage/belt/marine/standard/m39/elite_freelancer/fill_preset_inventory()
	for(var/i = 1 to storage_slots)
...
/obj/item/storage/belt/shotgun/wy/elite_freelancer/fill_preset_inventory()
	for(var/i = 1 to storage_slots)
